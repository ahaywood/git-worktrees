...
if git show-ref --verify --quiet "refs/heads/$base"; then
  run_command "Updating local $base branch..." git fetch origin "$base:$base"
fi
...
run_command "Installing dependencies" pnpm --silent install
run_command "Building App" pnpm run --silent build
